...
if(isset($_POST['add_slide'])){
 ...
 if(empty($slide_title) || empty($slide_image)){
  echo "<p class = 'bg-danger'>THis filed cannot be empty</p>";
 }
else{
...
while($row = fetch_array($query)){
$slide_active = display_image($row['slide_image']);

  $slides_active_admin =<<<DELIMETER

   <img class="img-responsive" src="../../resources/{$slide_active}" alt="">
...
while($row = fetch_array($query)){
$slide_thumb = display_image($row['slide_image']);

  $slides_thumb_admin =<<<DELIMETER

   <div class="col-xs-6 col-md-3 image_container">
      
      <a class="btn btn-danger" href="index.php?delete_slide_id={$row['slide_id']}"><span class="glyphicon glyphicon-remove"></span></a></td>

     
    <img width='200' class="img-responsive slide_image" src="../../resources/{$slide_thumb}" alt="">
