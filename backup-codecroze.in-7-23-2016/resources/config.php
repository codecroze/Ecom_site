...
defined("UPLOAD_DIRECTORY") ? null : define("UPLOAD_DIRECTORY" ,  "../resources/uploads"); //for uploaded image or other files


defined("DB_HOST") ? null : define("DB_HOST" , "localhost"); //if defined then process NULL else make it defined

defined("DB_USER") ? null : define("DB_USER" ,  "codecroz_ecom_db"); //if defined then process NULL else make it defined

defined("DB_PASS") ? null : define("DB_PASS" ,  "or14f6607"); //if defined then process NULL else make it defined

defined("DB_NAME") ? null : define("DB_NAME" , "codecroz_ecom_db"); //if defined then process NULL else make it defined
