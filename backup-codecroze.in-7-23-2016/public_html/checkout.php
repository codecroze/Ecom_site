...
<div class="row">
  ...
  <input type="hidden" name="business" value="shaalu.rawat-facilitator@hotmail.com">
...
<th>Items:</th>
<td><span class="amount"><?php echo isset($_SESSION['item_total_quantity']) ?$_SESSION['item_total_quantity']: $_SESSION['item_total_quantity']="0" ;
